import { colors, ColorsType } from "@shared/themes/colors";
import { fontConfig, fontSize } from "@shared/themes/fonts";
...
const Txt = styled.label<LabelStyleType>`
  ...
  font-family: ${(props) =>
    props.fontFamily ? props.fontFamily : fontConfig.inter};
